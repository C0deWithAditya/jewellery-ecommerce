...
class SelectedMaintenanceSystem {
  ...
  SelectedMaintenanceSystem.fromJson(Map<String, dynamic> json) {
    deliveryApp = '${json['deliveryman_app']}'.contains('1');
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['deliveryman_app'] = deliveryApp;
    return data;
  }
}
...
class MaintenanceTypeAndDuration {
  ...
  MaintenanceTypeAndDuration({String? maintenanceDuration, String? startDate, String? endDate});
