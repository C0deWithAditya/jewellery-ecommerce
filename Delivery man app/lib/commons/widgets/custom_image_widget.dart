...
class CustomImageWidget extends StatelessWidget {
  ...
  const CustomImageWidget({super.key, required this.image, required this.height, required this.width, this.fit = BoxFit.cover, this.placeholder = Images.placeholder});
