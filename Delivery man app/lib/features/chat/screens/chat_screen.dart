...
import 'package:emarket_delivery_boy/features/chat/widgets/message_bubble_widget.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver{
  ...
  void initState() {
    super.initState();
    Provider.of<ChatProvider>(Get.context!, listen: false).getChatMessages(widget.orderId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('${widget.userName}', style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Colors.white)),
            ...
            child: Container(width: 40,height: 40,
              ...
              child: ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.customerImageUrl}/${widget.profileImage}',
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Row(children: [
                ...
                Consumer<ChatProvider>(builder: (context, chatPro,_)=> InkWell(
                  onTap: () async {
                    if(Provider.of<ChatProvider>(context, listen: false).isSendButtonActive){
                      chatPro.sendMessage(_inputMessageController.text.trim(),chatPro.chatImage,widget.orderId,context).then((value){
